let defs = {
  ...
  "no_longer_supportedAt":{"u":"obsolete,e-waste (metaphorically)","i":"can't bring yourself to throw it away,lives in your junk drawer (metaphorically)"},
...
//"La_macetaAt":{"u":"El que nace pa'maceta, no sale del corredor.,(loteria)","i":"El que nace pa'maceta, no sale del corredor.,(loteria)"}
  ...
  "fifty_minute_hourAt":{"u":"how does that make you feel?","i":"therapy couch (metaphorically)"},
   ...
   "spell_checkAt":{"u":"mistaeks were made","i":"nobodies perfect"},
    ...
    "t_rex_armsAt":{"u":"vestigial?","i":"don't look up!"},
    "concentricAt":{"u":"spiral - not!","i":"insider trading"},
    "caused_by_vigorous_handshakesAt":{"i":"unable to tell the truth,(see also ANOSOGNOSIA)","u":"Year after year\\c,On the monkey's face\\c,A monkey's mask."},
    "you_apos_re_soaking_in_itAt":{"u":"unaware","i":"beauty\\c skin deep"},
    "indoor_hatAt":{"u":"stay warm","i":"hot head"},
    "a_series_of_explosionsAt":{"u":"waking up to","i":"collect them all"},
    "razor_bladeAt":{"u":"a clean shave","i":"by the short hairs"},
    "greenlandAt":{"u":"near-term stupid plans,(see HANDS OFF),(see A SERIES OF EXPLOSIONS)","i":"not as large as you think,(mercator projection), Chuck Schumer will be very dissapointed"},
    "ineffectual_finger_hyph_waggingAt":{"u":"Chuck Schumer is VERY disappointed,(metaphorically)","i":"getting things done"},
    "f__m__kAt":{"u":"ratings/rankings,(judgemental)","i":"survey says..."},
    "are_we_the_bad_guys_now_q_At":{"u":"ǝɹɐ ǝʍ 'sǝʎ","i":"ɐɔıɹǝɯɐ ɟo sǝʇɐʇs pǝʇıun"},
     "l_apos_arc_de_brutalismeAt":{"u":"glory","i":"ego"},
     "brickAt":{"u":"no step on snek","i":"render useless"},
     "_2014_unused_day_plannerAt":{"u":"regrets and sorrow","i":"such a waste"},
     "on_edgeAt":{"u":"on edge","i":"casting a shadow"},
     "solitaireAt":{"u":"let's play","i":"alone"},
     "loopingAt":{"u":"diversionary tactics","i":"for\\cdo\\cwhile,thrill ride"},
     "chicken_broccoli_tortilla_and_one_other_thingAt":{"u":"let them eat cake","i":"affordability (metaphorically)"},
    "perscriptionAt":{"u":"child-proof","i":"not child-proof"},
     "on_the_monkey_apos_s_face_elip_At":{"u":"year after year...","i":"true colors"},
     "goldilocksAt":{"u":"","i":""},
     "self_hyph_organized_criticalityAt":{"u":"suddenly","i":"gradually"},
     "hand_stencilAt":{"u":"souvenir","i":"signature"},
     "crop_circleAt":{"u":"dated mysteries","i":"'In Search Of',hosted by Lenord Nimoy,'Beyond Belief: Fact or Fiction',hosted by Jonathan Frakes"},
      "plate_spinnerAt":{"u":"frantic","i":"𝅘𝅥𝅮 Sabre Dance 𝅘𝅥𝅮"},
      "auraAt":{"u":"coming soon","i":"ache"},
      "templateAt":{"u":"template,unfulfilled,(see also CONCEPT OF A PLAN)","i":"sketchy"},
      "giant_com_gold_com_jewel_hyph_encrusted_crucifixAt":{"u":"ships in 3-4 buisness days","i":"unsettling"},
      "wellAt":{"u":"sources say","i":"deep dive,get to the bottom of things"},
      "sketch_artistAt":{"u":"identity","i":"suspect"},
      ...
      "billionaireAt":{"u":"the buck stops here,(why you don't get any)","i":"always needs more money"},
      "hex_wrenchAt":{"u":"assembly required","i":"destined for the junk drawer"},
      "conspiracy_theoryAt":{"u":"thinks apollo missions were faked","i":"tells you that apollo astronauts took pictures of flying saucers"},
      "rootAt":{"u":"cause","i":"store"},
      "homunculusAt":{"u":"little man","i":"my chymical romance"},
      "wandering_uterusAt":{"u":"𝅘𝅥𝅮 roam\\c if you want to 𝅘𝅥𝅮","i":"hysteria"},
      "fetusAt":{"u":"early stages","i":"future plans"},
      "travels_hyph_airport_barAt":{"u":"is there travel in your future?,have you ever traveled?,ever wanted to travel?,the cards know all","i":"refugees,forced to travel,[Rajie Cook]"},
      "travels_hyph_the_gift_shopAt":{"u":"souvenir","i":"duty free,[Roger Cook\\c Don Shanosky]"},
      "travels_hyph_customsAt":{"u":"nothing to declare","i":"you will be scrutinized"},
      "travels_hyph_lost_and_foundAt":{"u":"traces of you","i":"reuniting"},
      "step_on_a_crackAt":{"u":"sympathetic magic","i":"𝅘𝅥𝅮 When a problem comes along, you must whip it... 𝅘𝅥𝅮"},
      "el_niñoAt":{"u":"all grown up","i":"seasonal affective disorder"},
      "blindfoldedAt":{"u":"only see what you want to see","i":"blindsight"},
      "head_in_handAt":{"u":"where's your head at?","i":"standing on the shoulders of giants"},
      "backpackerAt":{"u":"carry on","i":"carry-on"},
      "shorts_weatherAt":{"u":"my eyes are up here!","i":"hey\\c nice t-shirt"},
      "unicornAt":{"u":"rare","i":"medium-rare"},
      "rope_skipperAt":{"u":"airborne","i":"high and mighty"},
      "roller_skaterAt":{"u":"spin control","i":"wheeler dealer"},
      "fellow_kidAt":{"u":"one of us","i":"(he's a narc!)"},
      "diverAt":{"u":"beneath the surface","i":"something's fishy"},
      "good_at_everythingAt":{"u":"gold  ̶m̶e̶t̶a̶l̶  medal performance","i":"cool headed"},
      "naclAt":{"u":"salt of the earth","i":"commonplace"},
      "hard_cheeseAt":{"u":"can't be spread on a cracker","i":"hard\\c sharp and salty,(just like you)"},
      "rat_KingAt":{"u":"e pluribus unum","i":"pulled in all directions"}, 
      "luckyAt":{"u":"are you feeling lucky?","i":"lucky day"},
      "membraneAt":{"u":"boundaries","i":"gatekeeper"},
      "sphexishAt":{"u":"stuck in a loop?","i":"digging deeper"},
      "wheel_of_eukaryotaAt":{"u":"reinventing the wheel","i":"𝅘𝅥𝅮 When a problem comes along, you must whip it... 𝅘𝅥𝅮"},
      "fortune_cookieAt":{"u":"a fool and their aphorism are soon parted","i":"this wise saying is wise (Lao Tzu)"},
      "tunguska_eventAt":{"u":"if a̶  [many] tree[s] falls̶  in the forest\\c, d̵o̵e̵s̵ ̵i̵t̵ [do they] make a sound?","i":"ok boomer!,(See also BLAST RADIUS)"},
      "sculpture_parkAt":{"u":"do not climb...","i":"monumental / rusty"},
      "bauplanAt":{"u":"born this way","i":"do dot fold\\c spindle or mutilate"},
      "sleeperAt":{"u":"the sleep of reason produces monsters","i":"sleeping:good\\c waking:bad"},
      "dvorak_handsAt":{"u":"idle hands...","i":"build a better mouse trap... who cares?"},
      "bridges_of_konigsbergAt":{"u":"desire paths","i":"burning bridges"},
      "foxgloveAt":{"u":"medicine","i":"poison"},
      "gazing_ballAt":{"u":"through the looking-glass","i":"through a glass\\c darkly"},
      "hockneyAt":{"u":"swimming","i":"polaroids"},
      "feederAt":{"u":"energy drink","i":"empty calories"},
      "pile_of_stonesAt":{"u":"team building exercise","i":"𝅘𝅥𝅮 everybody must get stoned 𝅘𝅥𝅮"},
      "algaeAt":{"u":"embarrassments","i":"blame"},
      "there_is_no_alternativeAt":{"u":"(TINA)","i":"no planet b"},
      "philsophical_zombieAt":{"u":"only reads the Hazel Barnes translation","i":"reads the original\\c en francais,(also\\c hungry for brains)"},
      "two_room_houseAt":{"u":"offered without explanation","i":"offered without explanation"},
      "swallowedAt":{"u":"problem?","i":"problem solved"},
      "swallowed_a_horseAt":{"u":"(see death card)","i":"...of course"},
      "proof_of_lifeAt":{"u":"(see death card)","i":"already dead inside"},
      "fires_out_westAt":{"u":"Long-distance influencer","i":"Tyger Tyger\\c burning bright\\c,in the forests of the night"},
      "popsicleAt":{"u":"favorite flavor: blue","i":"did not share"},
      "this_gestureAt":{"u":"...does not work in the real world","i":"futile gestures"},
      "lettuceAt":{"u":"when you thought you knew someone","i":"salad days"},
      "fire_saleAt":{"u":"burn baby burn","i":"where there's smoke..."},
      "meat_machineAt":{"u":"I\\c roast-bot","i":"we are more than mere machines\\c,we have that special seasoning, which machines lack...,(d'oh!)"},
      "run_and_tumbleAt":{"u":"wayfinder","i":"dead reckoning"},
...
let altTitles = { // for alternatives: remove "At"
  "step_on_a_crackAt":"break_your_mother_apos_s_back",
